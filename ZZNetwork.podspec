#
#  Be sure to run `pod spec lint ZZNetwork.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                        网络请求的封装，基于AFNetworking,扩展一些基本常用的业务功能。如网络请求的去重，网络请求结果缓存。请求错误协议的记录等等。
                   DESC

  s.homepage     = "https://github.com/saberge/ZZNetwork.git"
  ...
  #
    ...
    s.author             = { "zhenglaixian" => "saberge@163.com" }
  # Or just: s.author    = "zhenglaixian"
  # s.authors            = { "zhenglaixian" => "saberge@163.com" }
  # s.social_media_url   = "http://twitter.com/zhenglaixian"
  ...
  s.source       = { :git => "https://github.com/saberge/ZZNetwork.git", :tag => "#{s.version}" }
